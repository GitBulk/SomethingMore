...
namespace Tam.QRCode
{
    public class QRCodeGenerator
    {
        ...
        /// <summary>
        /// Here, the levels L (7%), M (15%), Q (25%) and H (30%) are available,
        /// whereby the percentage indicates how much of the QR-code can be
        /// hidden/destroyed until the error correction algorithm can’t recreate
